...
namespace StateMachine.ScriptableObjects
{
    ...
    {
        [SerializeField] private ScriptableState _originState;
        [SerializeField] private ScriptableCondition _condition;
        [SerializeField] private ScriptableState _trueState;
        [SerializeField] private ScriptableState _falseState;
